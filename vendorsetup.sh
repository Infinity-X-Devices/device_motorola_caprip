...
# Vendor
git clone https://github.com/Deivid-21s-Sources/proprietary_vendor_motorola_caprip.git -b lineage-22.2 vendor/motorola/caprip --depth=1
...
# Moto Camera
git clone https://gitlab.com/Deivid21/proprietary_vendor_motorola_MotCamera3.git -b android-15 vendor/motorola/MotCamera3 --depth=1
